export default class ICircuitoRepository {
    async crearCircuito(circuito) { // eslint-disable-line no-unused-vars
        throw new Error('Método crearCircuito debe ser implementado');
    }
